...
1. use the search functionality `here <https://github.com/rajkumar-d83/nse_project/issues>`__ to see if someone already filed the same issue;
...
1. `push <http://rogerdudler.github.io/git-guide/>`_ your feature branch to (your fork of) the NSE_project repository on GitHub;
